...
public class SESService {
    public static void sendMessage(String message) {
        ...
        String bodyText = "Olá este é um e-mail - " + message;
        ...
        try {
            send(client, "bianca.andrade@ifood.com.br", "bianca.andrade@ifood.com.br", "E-mail de teste - " + message,
                    bodyText, bodyHTML);
            client.close();

            System.out.println("E-mail envido.");
